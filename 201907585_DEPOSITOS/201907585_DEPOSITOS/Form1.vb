Public Class Form1
    Private Sub Button1CALCULAR_Click(sender As Object, e As EventArgs) Handles Button1CALCULAR.Click
        ...
        If RadioButton3.Checked = True Then
            ...
            End Select
            Saldo_Nuevo = Val(TextBox1CP.Text) + Val(TextBox2COB.Text) + Val(TextBox3EF.Text) + Val(TextBox6.Text)
        ...
        If RadioButton2.Checked = True Then
            ...
            End Select
            Saldo_Nuevo = Val(TextBox1CP.Text) + Val(TextBox2COB.Text) + Val(TextBox3EF.Text) + Val(TextBox6.Text) * Interes
            Label4SALDONUEVO.Text = Str(Saldo_Nuevo)
        End If
    ...
    Private Sub TextBox1_TextChanged(sender As Object, e As EventArgs) Handles TextBox1CP.TextChanged
    ...
    Private Sub Label5_Click(sender As Object, e As EventArgs) Handles Label5INTERES.Click
